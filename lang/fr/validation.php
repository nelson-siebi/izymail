...
return [
    ...
    */
    ...
    'ascii' => 'Le champ :attribute doit contenir uniquement des caractères alphanumériques et des symboles codés sur un octet.',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes de langue suivantes sont utilisées pour remplacer nos alias d'attributs
    | par quelque chose de plus convivial pour l'utilisateur tel que "Adresse e-mail" au lieu
    | de "email". Cela nous aide simplement à rendre les messages plus propres.
    |
    */
